      ...
      >
                        ...
                        <div className="mt-4">
                          <Link to={`/jidelnicek/${documentId}`}>
                            <motion.button
                              whileHover={{ scale: 1.05 }}
                              whileTap={{ scale: 0.95 }}
                              className="px-4 py-2 bg-gradient-to-r from-green-400 to-blue-500 text-white rounded-full shadow-md hover:shadow-lg transition"
                            >
                              Detail jídelníčku
                            </motion.button>
                          </Link>
        ...
        <div className="px-6 py-12 bg-gray-800">
          <h2 className="text-3xl font-semibold text-center mb-6">
            Co ti naše jídelníčky nabídnou?
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="p-6 bg-gray-700 rounded-lg shadow-md">
              <h3 className="text-xl font-bold mb-2">Vědecký přístup</h3>
              <p className="text-gray-400">
                Plány vycházejí z aktuálních výživových trendů a vědeckých dat.
              </p>
            </div>
            <div className="p-6 bg-gray-700 rounded-lg shadow-md">
              <h3 className="text-xl font-bold mb-2">Individuální přístup</h3>
              <p className="text-gray-400">
                Jídelníčky na míru podle tvých potřeb a cílů.
              </p>
            </div>
            <div className="p-6 bg-gray-700 rounded-lg shadow-md">
              <h3 className="text-xl font-bold mb-2">Zdravý životní styl</h3>
              <p className="text-gray-400">
                Pomoc při zlepšování tvého zdraví a kondice.
              </p>
            </div>
          </div>
        </div>
