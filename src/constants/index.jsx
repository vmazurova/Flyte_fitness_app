...
export const faq = [
  {
    id: "0",
    question:
      "Co všechno umí Flyte?                                                 ",
    answer:
      "Flyte je aplikace, která se zaměřuje především na sledování tvého pokroku, možnost přihlásit se na kurzy či zakoupit si jídelníček, trénikový plán.",
  },
  {
    id: "1",
    question: "Je k dispozici nějaká zkušební verze?",
    answer:
      "Flyte poskytuje 7 denní verzi zdarma. Ať už si vybereš zkusit kurz, tréninkový plán, jídelníček, má 7 dní na to odstoupit bez jakéhokoli poplatku.",
  },
  {
    id: "2",
    question: "Nabízí aplikace tréninkové plány pro začátečníky?",
    answer:
      "Ano, aplikace nabízí tréninkové plány pro začátečníky, pokročilé i profesionály. Každý plán je přizpůsoben vaší kondici a cílům.",
  },
  {
    id: "3",
    question: "Nabízí aplikace skupinové cvičení nebo komunitu?",
    answer:
      "no, můžete se připojit ke skupinovým kurzům a komunitním výzvám, které vám umožní cvičit spolu s dalšími uživateli a sdílet pokrok.",
  },

  {
    id: "4",
    question: "Jaké typy diet aplikace nabízí?",
    answer:
      "Aplikace obsahuje různé dietní plány, včetně keto, vegetariánské, vysokoproteinové a dalších. Plány jsou přizpůsobeny vašim cílům a preferencím.",
  },
  {
    id: "5",
    question: "Jaký je rozdíl mezi jednotlivými úrovněmi členství?",
    answer:
      "Každá úroveň členství poskytuje různé výhody, jako například přístup k více tréninkovým plánům, pokročilé sledování pokroku, osobní konzultace s trenérem a exkluzivní kurzy.",
  },
  {
    id: "6",
    question: "Jak často se aktualizují tréninkové plány?",
    answer:
      "Tréninkové plány jsou aktualizovány každý měsíc, abyste měli stále nové výzvy a možnosti.",
  },
  {
    id: "7",
    question: "Jak aplikace pomáhá s motivací?",
    answer:
      "Aplikace nabízí motivační funkce, jako jsou připomínky, odměny za dosažení cílů a možnost sdílet pokrok s přáteli.",
  },
  {
    id: "8",
    question: "Jak je chráněno mé soukromí a data?",
    answer:
      "Veškerá data jsou chráněna v souladu s GDPR a používáme bezpečnostní technologie, které zajistí ochranu vašich osobních údajů.",
  },
  {
    id: "9",
    question: "Jak zruším své předplatné?",
    answer:
      "Předplatné lze kdykoliv zrušit přímo ve vašem účtu pod sekcí „Nastavení“.",
  },
];
...
export const plans = [
  {
    ...
    features: [
      "Možnost cvičit jak dlouho chcete a kolikrát chcete",
  ...
  },
  {
    ...
    priceMonthly: 958,
    priceFull: 11490,
    caption: "Pokud si chceš máknout",
    features: [
      "Přizpůsobený cvičební plán",
      "Možnost uplatnění slev u našich partnerů",
...
export const testimonials = [
  {
    id: "0",
    name: "Martina Černá",
    role: "Nutriční poradce",
    avatarUrl: "/images/trainer1.jpg",
    comment:
      "Díky aplikaci můžu svým klientům nabídnout personalizované plány, které jim opravdu vyhovují. Možnost sledování jídelníčku je k nezaplacení.",
  },
  {
    id: "1",
    name: "Petr Novotný",
    role: "Osobní trenér",
    avatarUrl: "/images/trainer2.jpg",
    comment:
      "Tahle aplikace je skvělá na sledování pokroku a plánování tréninků. Všichni mí klienti si pochvalují přehlednost a jednoduchost.",
  },

  {
    ...
    avatarUrl: "/images/trainer4.jpg",
    comment:
      "Na této aplikaci se mi líbí hlavně jednoduché a intuitivní prostředí. Klienti mohou sledovat své výsledky a já mám lepší přehled o jejich pokroku.",
  },

  {
    ...
    role: "Uživatel",
    avatarUrl: "/images/trainer3.jpg",
    comment:
      "Moderní a přehledná aplikace, která motivuje k lepším výsledkům. Ideální pro každého, kdo chce dosáhnout svých fitness cílů.",
  },
];
...
export const logos = [
  {
    id: "0",
    title: "Afterpay",
    url: "/images/logos/ContoursLogo.png",
    width: 210,
    height: 40,
  },
  {
